...
def main(dir_mzml,dir_analysis):
    ...
    print('Filtering out ions with present in less than 50% of the samples')
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python fipy.py <dir_mzml> <dir_analysis>")
        sys.exit(1)
    
    dir_mzml = sys.argv[1]  # The first argument is the directory for mzML files
    dir_analysis = sys.argv[2]  # The second argument is the directory for analysis results
    
    main(dir_mzml,dir_analysis)